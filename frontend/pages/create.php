        ...
        <div class="row gx-lg-5">
                ...
                <div style="max-width: unset" class="rounded shadow-sm signup-form wow fadeInUp2" data-wow-offset="30" data-wow-duration="1.5s" data-wow-delay="0.15s">
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" enctype="multipart/form-data">
                        ...
                        <?php if (isset($site_err)) : ?>
                            <p class="text-danger mb-3"><?php echo $site_err ?></p>
                        <?php endif ?>
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control <?php echo (!empty($title_err)) ? 'is-invalid' : ''; ?>" name="title" placeholder="Enter title of this story" required="required" fdprocessedid="9pr50o">
                            <span class="invalid-feedback"><?php echo $title_err; ?></span>
                        </div>
                        <div class="form-group">
                            <textarea class="form-control <?php echo (!empty($email_err)) ? 'is-invalid' : ''; ?>" required placeholder="Start typing..." name="content" id="content" rows="10" cols="80"></textarea>
                            <script>
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col"> <input type="file" accept="image/*" class="form-control <?php echo (!empty($image_err)) ? 'is-invalid' : ''; ?>" id="image" name="image" placeholder="image" required="required" fdprocessedid="eg38to">
                        ...
                        <div class="form-group">
                            <?php if ($role == "admin") : ?>
                                <input type="checkbox" name="published" id="published"><label class="p-2">Check to Publish. </label>
                            <?php endif;  ?>
                        </div>
                        <div class="form-group">
                            <button value="create" type="submit" class="btn btn-primary btn-block" fdprocessedid="mtdgle">Post</button>
                        </div>
                    </form>
            ...
            <div class="col-lg-4 sidebar left-line ps-5">
                <div class="widget author text-center">
                    <a href="#"><img class="rounded-circle" width="190" src="<?php echo WEBPATH ?>/frontend/assets/images/<?php echo $user->image ?>" alt="author"></a>
